      ...
      <div className="container w-full max-w-4xl">
        ...
        <div className="mb-8 rounded-lg bg-white p-8 shadow">
          ...
          <p className="text-muted-foreground">
            You&apos;re all set to start creating engaging courses. Here&apos;s
            what you can do:
          </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground sm:text-sm">
                    Discover courses created by our community. Save interesting
                    courses to your library or get inspired for your own
                    content.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground sm:text-sm">
                    Access all your created courses and saved community content
                    in one place. Organize and manage your learning journey.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Write your topic, select duration (15-60 mins), and let our AI
                  help you create an engaging course in minutes.
                </p>
              </div>
              <div className="rounded-lg border p-4">
          ...
          <div className="rounded-lg bg-white p-8 shadow">
            <h3 className="mb-4 text-lg font-semibold">Community Highlights</h3>
